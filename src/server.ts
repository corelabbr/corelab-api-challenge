...
import NoteService from "./core/notes/service/NotesService";
import NoteRepositoryMemory from "./external/memory/NoteRepositoryMemory";
...
// const noteRepository = new NoteRepositoryMemory();
