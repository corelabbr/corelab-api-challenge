...
export class MemoryTaskRepository {
    ...
    async editTask(id: string, title: string, content: string, color: string | 'white' | 'blue' | 'green' | 'yellow' | 'salmon' | 'red' | 'blue2' | 'pink' | 'lemon' | 'orange' | 'gray' | 'gray2' | 'brown'): Promise<Task> {
